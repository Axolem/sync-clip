...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_clip_ffi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_clip_ffi_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureClipFfiInitialized()
...
open class Session: SessionProtocol, @unchecked Sendable {
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_clip_ffi_fn_clone_session(self.pointer, $0) }
    }
    /**
     * Join a Sync Group (blocking). Starts Armed.
     */
public convenience init(linkKeyBytes: Data, relayWsUrl: String, ephemeralIdBytes: Data)throws  {
    let pointer =
        try rustCallWithError(FfiConverterTypeSessionError_lift) {
    uniffi_clip_ffi_fn_constructor_session_new(
        FfiConverterData.lower(linkKeyBytes),
        FfiConverterString.lower(relayWsUrl),
        FfiConverterData.lower(ephemeralIdBytes),$0
    )
}
    ...
    deinit {
        ...
        try! rustCall { uniffi_clip_ffi_fn_free_session(pointer, $0) }
    }
...
open func isSyncIdle() -> Bool  {
     ...
     * Non-blocking poll for the next applied remote Clip.
     */
open func pollApplied() -> AppliedClipFfi?  {
    return try!  FfiConverterOptionTypeAppliedClipFfi.lift(try! rustCall() {
    uniffi_clip_ffi_fn_method_session_poll_applied(self.uniffiClonePointer(),$0
    )
})
}
     ...
     * Publish plain text while Armed (created_at = now millis).
     */
open func publishText(text: String)throws   {try rustCallWithError(FfiConverterTypeSessionError_lift) {
    uniffi_clip_ffi_fn_method_session_publish_text(self.uniffiClonePointer(),
...
#if compiler(>=6)
extension AppliedClipFfi: Sendable {}
#endif


extension AppliedClipFfi: Equatable, Hashable {
    public static func ==(lhs: AppliedClipFfi, rhs: AppliedClipFfi) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeAppliedClipFfi: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AppliedClipFfi {
        return
            try AppliedClipFfi(
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAppliedClipFfi_lift(_ buf: RustBuffer) throws -> AppliedClipFfi {
    return try FfiConverterTypeAppliedClipFfi.lift(buf)
}
...
public struct FfiConverterTypeSessionError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SessionError {
        ...
        case 1: return .InvalidLinkKey
        case 2: return .InvalidEphemeralId
        case 3: return .InvalidBase32(
    ...
    public static func write(_ value: SessionError, into buf: inout [UInt8]) {
        ...
        case let .InvalidBase32(v1):
            writeInt(&buf, Int32(3))
            FfiConverterString.write(v1, into: &buf)
            
        
        case let .JoinFailed(v1):
...
fileprivate struct FfiConverterOptionTypeAppliedClipFfi: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeAppliedClipFfi.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeAppliedClipFfi.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
 ...
 */
public func defaultRelayWsUrl() -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_clip_ffi_fn_func_default_relay_ws_url($0
    )
})
}
/**
 ...
 */
public func generateEphemeralId() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_clip_ffi_fn_func_generate_ephemeral_id($0
    )
})
}
/**
 ...
 */
public func generateLinkKey() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_clip_ffi_fn_func_generate_link_key($0
    )
})
}
 ...
 */
public func linkKeyFromBase32(encoded: String)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeSessionError_lift) {
    uniffi_clip_ffi_fn_func_link_key_from_base32(
 ...
 */
public func linkKeyToBase32(key: Data) -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_clip_ffi_fn_func_link_key_to_base32(
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_clip_ffi_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_clip_ffi_checksum_func_default_relay_ws_url() != 54440) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_clip_ffi_checksum_func_generate_ephemeral_id() != 45804) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_clip_ffi_checksum_constructor_session_new() != 14615) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureClipFfiInitialized() {
